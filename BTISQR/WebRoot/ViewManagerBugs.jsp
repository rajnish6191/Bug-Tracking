...
<div id="latest-post" class="wide-post">
	...
	<div class="entry">
	  <p>&nbsp;</p>
	    <table width="687" height="255" border="0">
          <tr>
            ...
            <fieldset>
               <legend class="style1">View Bug Status</legend>
               <br /> 
	     ...
	     try{
         	...
         	{
        %>
               <td width="18" bgcolor="#E7B04F"><div align="center" class="style3"><input type="checkbox" name="ch" id="checkbox" onclick="SetChecked('ch')"/></div></td>
               <td width="44" bgcolor="#E7B04F"><div align="center" class="style2 style8"><strong>Bug ID</strong></div></td>
               <td width="87" bgcolor="#E7B04F"><div align="center" class="style2 style8"><strong>Bug Name</strong></div></td>
               <td width="80" bgcolor="#E7B04F" class="style3"><div align="center">Raised Date</div></td>
               <td width="79" bgcolor="#E7B04F" class="style3"><div align="center">Priority</div></td>
               <td width="74"  bgcolor="#E7B04F" class="style3"><div align="center">Status</div></td>
          ...
          %>
                  ...
                  <td bgcolor="#C3D7BA"><div align="center" class="style7"><a href="EditBug.jsp?id=<%=bugid%>"><%=(aBug.getBugName())%></a></div></td>
                  ...
                  {%>
                  <div align="center" class="style7"><a href="ViewSolution.jsp?id=<%=bugid%>" target="_blank">View</a></div>
                 <% }
                   %>
                  </td>
                  </tr>
      ...
      %>
                  <tr>
                    <td height="24" colspan="9"><div align="center" class="style3"><strong>No Records Found</strong></div></td>
                  </tr>
                  <%
      	}
      	} catch (Exception e) {
        ...
        %>
                  <tr>
                    <td colspan="9"><div align="center">
                        <input type="button" name="button" id="button" value="Delete Bug"/>
                      &nbsp;
                   </div></td>
                  </tr>
                </table>
