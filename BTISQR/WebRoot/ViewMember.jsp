...
%>
	    <table width="646" height="255" border="0">
          <tr>
            ...
            <fieldset>
               <legend class="style1">View Member</legend>
               <br /> 
                    ...
                    <input type="hidden" name="role" value="<%=request.getParameter("role") %>"/>
                       <table border="0" align="center">
                        <tr>
                          ...
                          <td width="182"><input type="text" name="fname" class="textfield" value="<%=profile.getFirstName() %>" readonly/>                          </td>
                        </tr>
                        <tr>
                          <td><span class="style3 style13"><strong>Last Name </strong></span></td>
                          <td><input type="text" name="lname" class="textfield" value="<%=profile.getLastName() %>" readonly/>                          </td>
                        </tr>
                        <tr>
                          <td><span class="style3 style13"><strong>Birth Date </strong></span></td>
                          <td><input type="text" name="bdate" readonly="readonly" value="<%=DateWrapper.parseDate(profile.getBirthDate1())%>"  readonly/> </td>
                        </tr>
                        <tr>
                          <td class="style3 style13"><strong>House No</strong></td>
                          <td><input type="text" name="hno" class="textfield" value="<%=profile.getHno() %>" readonly/></td>
                        </tr>
                        <tr>
                          <td class="style3 style13"><strong>Street</strong></td>
                          <td><input type="text" name="street" class="textfield" value="<%=profile.getStreet() %>"  readonly/></td>
                        </tr>
                        <tr>
                          <td><span class="style3 style13"><strong>City</strong></span></td>
                          <td><input type="text" name="city" value="<%=profile.getCity()%>"  readonly/></td>
                        </tr>
                        <tr>
                          <td><span class="style3 style13"><strong>State</strong></span></td>
                          <td><input type="text" name="state" value="<%=profile.getState()%>"  readonly/></td>
                        </tr>
                        <tr>
                          <td><span class="style3 style13"><strong>Country</strong></span></td>
                          <td><input type="text"  name="country" value="<%=profile.getCountry()%>" readonly/>
                              </td>
                        </tr>
                        <tr>
                          <td class="style3 style13"><strong>Pincode</strong></td>
                          <td><input type="text" name="pincode" class="textfield" value="<%=profile.getPincode() %>" readonly/></td>
                        </tr>
                        <tr>
                          <td class="style3 style13"><strong>Contact No</strong></td>
                          <td><input type="text" name="phoneno" class="textfield" value="<%=profile.getPhoneNo() %>" readonly/></td>
                        </tr>
                        <tr>
                          <td class="style3 style13"><strong>Email</strong></td>
                          <td><input type="text" name="email" class="textfield" value="<%=profile.getEmail() %>" readonly/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td colspan="2"><div align="center">
                              <input name="Input" type="button" value="Back" onclick="javascript:history.back(-1);"/>
                          </div></td>
                        </tr>
                      </table>
            </form>
