...
<div id="latest-post" class="wide-post">
	  ...
	  <p>&nbsp;</p>
	    <table width="709" height="255" border="0">
          <tr>
            ...
            <fieldset>
               <legend class="style1">View Managers</legend>
               <br /> 
 ...
 %> 
        <td bgcolor="#C3D7BA"><div align="center" class="style7"><a href="EditMember.jsp?id=<%=loginname%>&role=manager&tpage=ViewManagers.jsp?header=list"><%=loginname%></a></div></td> 
        <td bgcolor="#C3D7BA"><div align="center" class="style7"><a href="EditMember.jsp?id=<%=loginname%>&role=manager&tpage=ViewManagers.jsp?header=list"><%=(profile.getFirstName())%> <%=(profile.getLastName())%></a></div></td>
      ...
      <tr>
        <td colspan="5"><div align="center">
          ...
          <input type="button" name="button" id="button" value="Add New" onClick="javascript:location.href='DispatchController?page=AddNewMember.jsp&role=manager&tpage=ViewManagers.jsp?header=list'"/>
          &nbsp;
          <%
          	if (!aCoreHash.isEmpty()) {
          %>
